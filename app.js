...
app.get('/webhook', function (req, res) {
    res.status(200).send("VALIDATION_TOKEN : " + process.env.MESSENGER_VALIDATION_TOKEN + "<br> Secret : " + config.get('appSecret') + "<br> pageAccessToken : " + config.get('pageAccessToken'));
  if (req.query['hub.mode'] === 'subscribe' &&
      req.query['hub.verify_token'] === VALIDATION_TOKEN) {
    console.log("Validating webhook");
    res.status(200).send(req.query['hub.challenge']);
  } else {
      res.status(200).send("my name is pawan");
